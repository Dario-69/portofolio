...
$news_list = $pdo->prepare("SELECT COUNT(*) AS nb FROM newsletter");
$news_list->execute();
$newsletters=$news_list->fetch();

$msg_list = $pdo->prepare("SELECT COUNT(*) AS nb FROM contact");
$msg_list->execute();
$messages=$msg_list->fetch();

$services_nb = $pdo->prepare("SELECT COUNT(*) AS nb FROM services");
$services_nb->execute();
$services=$services_nb->fetch();
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        <span class="ms-1 font-weight-bold">BlingBlingServices</span>
      </a>
    </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Inscrits au newsletters</p>
                    <h5 class="font-weight-bolder mb-0">
                      <?php echo $newsletters['nb']; ?>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Messages reçus</p>
                    <h5 class="font-weight-bolder mb-0">
                      <?php echo $messages['nb']; ?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
