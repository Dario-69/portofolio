<?php 
  ...
  $resultnbr = $conn->query("SELECT COUNT(*) AS nb FROM blog");
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Blog<br><span><?php echo $nbr_item['nb']; ?> articles écrits</span></h5>
              ...
              <table class="table datatable">
                ...
                <?php foreach ($articles as $article): ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $article['sujet'] ?></td>
                    <td><?php echo $article['datepub'] ?></td>
                    <td><a href="article/?titre=<?=$article['titre']?>">Lire l'article</a></td>
                  </tr>
