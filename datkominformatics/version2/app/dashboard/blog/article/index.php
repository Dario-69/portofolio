    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Un article écrit le <?php echo $article[5]; ?></h5>
                <hr>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <strong>Titre : </strong><span><?php echo $article[2];?></span>
                ...
                <p><?php echo nl2br(html_entity_decode($article[4])); ?></p>
