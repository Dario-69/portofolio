  ...
  if(isset($_GET['email'])){
    ...
    if(empty($email)){
      header('location: ../index.php');
        ...
        $result = $conn->query("SELECT * FROM messages WHERE email = '".$email."'");
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Un nouveau message envoyé par <?php echo $message[1]; ?> le <?php echo $message[4]; ?></h5>
                
                <p><?php echo $message[3]; ?></p>

                <hr>
                <p class="text-end">Envoyé par <?php echo $message[1]; ?> le <?php echo $message[4]; ?></p>
                <hr>
                ...
                <a href="mailto:<?php echo $message[2]; ?>"><?php echo $message[2]; ?></a>
