<?php 
  ...
  $nbr_messages = $resultsms->fetch_assoc();
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Nos messages</h5>
                <p>Nous avons <?php echo $nbr_messages['nb']; ?> reçus messages</p>
                ...
                <table class="table datatable">
                  ...
                  <?php foreach ($messages as $message): ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo $message['datedenvoi'] ?></td>
                      <td><a href="contenu/?email=<?= $message['email'];?>">Lire le message</a></td>
                    </tr>
