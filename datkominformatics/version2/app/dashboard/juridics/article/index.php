  ...
  if(isset($_GET['nature'])){
    ...
    if(empty($nature)){
      header('location: ../index.php');
        ...
        $result = $conn->query("SELECT * FROM juridics WHERE nature = '".$nature."'");
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Un article écrit le <?php echo $article[3]; ?></h5>
                <hr>

                <strong>Sujet : </strong><span><?php echo $article[1];?></span>

                <hr>

                <?php echo nl2br(html_entity_decode($article[2])); ?>
