<?php 
  ...
  $resultnbr = $conn->query("SELECT COUNT(*) AS nb FROM juridics");
  $nbr_item = $resultnbr->fetch_assoc();

  $result = $conn->query("SELECT * FROM juridics ORDER BY id DESC");
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="../juridics/">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Docs Juridiques</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Docs Juridiques<br><span><?php echo $nbr_item['nb']; ?> articles écrits</span></h5>
            
              <div>

                <a href="add/">Ecrire un nouvel article</a>
              ...
              <table class="table datatable">
                ...
                <?php foreach ($articles as $article): ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $article['nature'] ?></td>
                    <td><?php echo $article['datepub'] ?></td>
                    <td><a href="article/?nature=<?= $article['nature'] ?>">Lire l'article</a></td>
                  </tr>
