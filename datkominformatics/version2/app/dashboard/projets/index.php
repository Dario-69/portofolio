<?php 
  ...
  $resultnbr = $conn->query("SELECT COUNT(*) AS nb FROM projets");
  $nbr_item = $resultnbr->fetch_assoc();

  $result = $conn->query("SELECT * FROM projets ORDER BY id DESC");
          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <p><?php echo $nbr_item['nb']; ?> projets démarrés depuis le site</p>
                ...
                <table class="table datatable">
                  ...
                  <?php foreach ($projets as $projet): ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo $projet['datedenvoi'] ?></td>
                      <td><a href="contenu/?email=<?=$projet['email'] ?>">En savoir plus</a></td>
                    </tr>
