...
<head>
    ...
    <meta name="description" content="Découvrez les différents projets de création web réalisés par l'agence. Création de site internet sur mesure, accompagnement digital et résultats obtenus">
...
<body>
    ...
    <div class="content">
        ...
        <!-- Header Section -->
        <div class="container-fluid" id="head-pages">
                            ...
                            <ul>
                                ...
                                <nav class="overlay-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="page-link-2" href="#">Portfolio</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <h1 id="titre">Créons ensemble quelque chose d'extraordinaire</h1>
        ...
        <div class="container">
            ...
            <div class="row droite_text mb-4">
                ...
                ?>
                        <?php foreach ($projects as $project): ?>
                            ...
                            <div class="col-md-6 mt-5 text-center">
                                ...
                                <a href="study-case/index.php?id=<?= $project['id'];?>" target="_blank" rel="noopener noreferrer" class="lien_projet">

                                    <img src="../admin/dashboard/portfolio/add/projects/cover/<?php echo $project['cover']; ?>" alt="<?= $project['nom'];?>" width="100%">
                                    
                                    <h3 class="nom_projet mt-1"><?= $project['nom'];?></h3>
                                    <span class="type_projet"><?= $project['what'];?></span>
                    ...
                    <?php } 
                        ...
                        <p>Be our first accomplishment</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 id="ready">Prêt a<br>discuter de votre<br>prochain projet ?</h1>

                    </div>

                    <div class="col-md-6">

                        <a href="mailto:hello@datkominformatics.com" class="getquote">Contactez-nous</a>
