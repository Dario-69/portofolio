                    ...
                    <form action="" id="form-project" method="POST" role="form">
                        ...
                        <p id="form_p">
                            ...
                            Je m'intéresse à <select name="want" id="want" class="inpoot">
                                <option value=""></option>
                                <option value="Landing Page / Site Vitrine">Landing Page / Site Vitrine</option>
                                <option value="E-commerce">E-commerce</option>
                                <option value="CMS">CMS</option>
                                <option value="Application web">Application web</option>
                                <option value="Site web sur-mesure">Site web sur-mesure</option>
                            </select>
                            <br>
            ...
            $('#form-project').on('submit',function(e){
                ...
                if(nom != "" && phone != "" && email != "" && about != "" && want != ""){
                    ...
                    $.ajax({
                        ...
                        type:'POST',
                        url:'../../config/web.php', //===PHP file name====
                        data:{
                            nom : nom,
                            phone : phone,
                            email : email,
