                ...
                <div class="col-md-10 mt-2 mb-5">
                    ...
                    <form action="" id="form-project" method="POST" role="form">
                        ...
                        <p id="form_p">
                            ...
                            <br>
                            Un petit mot sur mon projet <br> <textarea name="about" id="about" cols="30" rows="3" class="form-control inpoot" placeholder="Mon projet concerne..."></textarea>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#form-project').on('submit',function(e){
                ...
                if(nom != "" && phone != "" && email != "" && about != ""){

                    $.ajax({

                        type:'POST',
                        url:'../../config/project.php', //===PHP file name====
                        data:{
                            nom : nom,
                            phone : phone,
                            email : email,
