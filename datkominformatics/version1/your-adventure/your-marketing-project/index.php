                    ...
                    <form action="" id="form-project" method="POST" role="form">
                        ...
                        <p id="form_p">
                            ...
                            Je m'intéresse à <select name="want" id="want" class="inpoot">
                                <option value=""></option>
                                <option value="Strategie de marketing">Strategie de marketing</option>
                                <option value="Campagne publicitaire sociale">Campagne publicitaire sociale</option>
                                <option value="Gestion de communauté">Gestion de communauté</option>
                            </select>
                            <br>
            ...
            $('#form-project').on('submit',function(e){
                ...
                if(nom != "" && phone != "" && email != "" && about != "" && want != ""){
                    ...
                    $.ajax({
                        ...
                        type:'POST',
                        url:'../../config/marketing.php', //===PHP file name====
                        data:{
                            nom : nom,
                            phone : phone,
                            email : email,
