            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <p>Vous êtes perdus ? Trouver votre chemin</p>
            ...
            <div class="row">
                ...
                <div class="col-md-11 mt-5">
                    ...
                    <ul>
                        ...
                        <li><a href="../our-agency/index.php">Notre agence</a></li>
                        <li><a href="../our-services/index.php">Nos services</a></li>
                        <li><a href="../contact/index.php">Contact us</a></li>
                        <li><a href="../blog/index.php">Blog</a></li>
                        <li><a href="../blog/topic/branding/index.php">Blog / Branding</a></li>
                        <li><a href="../blog/topic/design/index.php">Blog / Design</a></li>
                        <li><a href="../blog/topic/web/index.php">Blog / Web</a></li>
                        <li><a href="../careers/index.php">Careers</a></li>
                        <li><a href="../portfolio/index.php">Portfolio</a></li>
                        <li><a href="../legal-notice/index.php">Legal Notice</a></li>
                        <li><a href="../privacy-policy/index.php">Privacy policy</a></li>
                        <li><a href="../terms-of-use/index.php">Terms of use</a></li>
