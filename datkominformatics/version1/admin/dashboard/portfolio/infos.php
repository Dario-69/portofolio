...
session_start();
  ...
  if(isset($_GET['id'])){
    ...
    if(empty($id)) {
        ...
        $realisations = $sth->fetch(PDO::FETCH_ASSOC);
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Etude de cas N°<?php echo $realisations['id']; ?></h4>
                    <div>

                        <h2><?php echo $realisations['nom']; ?></h2> <br>
                        <h6><?php echo $realisations['what']; ?></h6> <br>
                        <h6><?php echo $realisations['about']; ?></h6>
                        <a href="<?php echo $realisations['lienprojet']; ?>" target="_blank" rel="noopener noreferrer"></a>
                        <br>

                        <img src="add/projects/cover/<?php echo $realisations['cover']; ?>" alt="cover" width="100%">

                        <img src="add/projects/images/<?php echo $realisations['img_un']; ?>" alt="image1" width="100%">
                        <img src="add/projects/images/<?php echo $realisations['img_deux']; ?>" alt="image2" width="100%">
                        <img src="add/projects/images/<?php echo $realisations['img_trois']; ?>" alt="image3" width="100%">
                        <img src="add/projects/images/<?php echo $realisations['img_quatre']; ?>" alt="image4" width="100%">
