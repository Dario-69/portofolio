...
session_start();
  ...
  $blog_lnb = $pdo->prepare("SELECT COUNT(*) AS nb FROM portfolio");
  $blog_lnb->execute();
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title card-title-dash">Portfolio</h4>
                         <p class="card-subtitle card-subtitle-dash">nous avons <?php echo $blog_list['nb']; ?> études cas</p>
                        </div>
                        <div>
                          <a href="add/index.php" class="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i class="mdi mdi-plus"></i>Ajouter un nouveau</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                        <?php foreach ($portfolio as $realisations): ?>
                          <tr>
                            <td class="py-1"><?= $realisations['id'];?></td>
                            <td><a href="infos.php?id=<?= $realisations['id'];?>"><?= $realisations['nom'];?></a></td>
                            <td><?= $realisations['what'];?></td>
                          </tr>
                        <?php endforeach ?>
                        </tbody>
                      </table>
