<?php
  ...
  $blog_lnb = $pdo->prepare("SELECT COUNT(*) AS nb FROM users");
  $blog_lnb->execute();
                  ...
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                         ...
                         <p class="card-subtitle card-subtitle-dash">nous sommes <?php echo $blog_list['nb']; ?> utilisateurs</p>
                        </div>
                        <div>
                          <a href="add/index.php" class="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i class="mdi mdi-plus"></i>Ajouter un nouvel utilisateur</a>
                        </div>
                    </div>
