<?php
  ...
  if(isset($_GET['id'])){
    ...
    if(empty($id)) {
        ...
        $offers = $sth->fetch(PDO::FETCH_ASSOC);
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Offre N°<?php echo $offers['id']; ?></h4>
                    <div>

                        <h2><?php echo $offers['nom']; ?></h2>
                        <h6><?php echo $offers['what']; ?></h6>
                        <h6>Publié le <?php echo $offers['dateligne']; ?> & Commence le <?php echo $offers['datedebut']; ?> minutes</h6>
                        <br>
                        <h5><?php echo $offers['message']; ?></h5>
