                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title card-title-dash">Careers</h4>
                        </div>
                        <div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php foreach ($careers as $offers): ?>
                            <tr>
                              <td class="py-1"><?= $offers['id'];?></td>
                              <td><a href="infos.php?id=<?= $offers['id'];?>"><?= $offers['nom'];?></a></td>
                              <td><?= $offers['what'];?></td>
                              <td><?= $offers['dateligne'];?></td>
                            </tr>
                          <?php endforeach ?>
                        </tbody>
                      </table>
