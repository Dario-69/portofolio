<?php
  ...
  if(isset($_GET['id'])){
    ...
    if(empty($id)) {
        ...
        $blog_topic = $sth->fetch(PDO::FETCH_ASSOC);
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Article N°<?php echo $blog_topic['id']; ?></h4>
                    <div>

                        <h2><?php echo $blog_topic['titre']; ?></h2>
                        <h6><?php echo $blog_topic['what']; ?></h6>
                        <h6>Publié le <?php echo $blog_topic['datepub']; ?> & peut etre lu en <?php echo $blog_topic['minlecture']; ?> minutes</h6>
                        <br>
                        <h5><?php echo $blog_topic['prefix']; ?></h5>
                        <img src="add/article/cover/<?php echo $blog_topic['cover']; ?>" alt="<?php echo $blog_topic['titre']; ?>" width="100%">
                    
                        <?php echo nl2br(html_entity_decode($blog_topic['note'])); ?>
