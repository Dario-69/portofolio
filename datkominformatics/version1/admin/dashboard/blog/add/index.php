...
$prefix = $_POST['prefix'];
$minlecture = $_POST['minlecture'];
$post = filter_var(htmlentities($_POST["note"]), FILTER_SANITIZE_STRING) ;

//Cover
move_uploaded_file($_FILES["cover"]["tmp_name"],"article/cover/" . $_FILES["cover"]["name"]);
$cover_file = $_FILES["cover"]["name"];

$sql = "INSERT INTO `blog` (`titre`, `what`, `prefix`, `cover`, `minlecture`, `note`) VALUES('$titre','$what','$prefix','$cover_file','$minlecture','$post')";
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title card-title-dash">Ecrire article</h4>
                        </div>
                    </div>

                    <form class="mt-3" role="form" method="post" enctype="multipart/form-data">

                        <div class="form-group">

                            <label for="exampleSelectGender">Quel sujet d'article écrivez-vous ?</label>
                            <select class="form-control" id="exampleSelectGender" name="what">
                                <option></option>
                        ...
                        <div class="form-group">
                          <label for="exampleInputName1">Quel est le titre ?</label>
                          <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="titre">
                        </div>

                        <div class="form-group">
                            <label for="exampleTextarea1">Introduisez votre article</label>
                            <textarea class="form-control" id="" cols="30" rows="3" name="prefix"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="exampleInputName1">Estimez le temps de lecture en minutes de votre article</label>
                            <input type="text" class="form-control" id="exampleInputName1" placeholder="15" name="minlecture">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <label for="">Ecrivez votre article</label><br>
                            
                        </div>

                        <textarea class="summernote" name="note" id="summernote"></textarea>
