<?php
  ...
  $blog_lnb = $pdo->prepare("SELECT COUNT(*) AS nb FROM blog");
  $blog_lnb->execute();
  $blog_list=$blog_lnb->fetch();
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title card-title-dash">Nos articles</h4>
                         <p class="card-subtitle card-subtitle-dash">nous avons écrit <?php echo $blog_list['nb']; ?> articles</p>
                        </div>
                        <div>
                          <a href="add/index.php" class="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i class="mdi mdi-plus"></i>Ecrire un nouveau</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <?php foreach ($blog as $blog_topic): ?>
                            <tr>
                              <td class="py-1"><?= $blog_topic['id'];?></td>
                              <td><a href="infos.php?id=<?= $blog_topic['id'];?>"><?= $blog_topic['titre'];?></a></td>
                              <td><?= $blog_topic['what'];?></td>
                              <td><?= $blog_topic['minlecture'];?></td>
                              <td><?= $blog_topic['datepub'];?></td>
                            </tr>
                          <?php endforeach ?>
