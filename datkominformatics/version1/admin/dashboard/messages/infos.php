                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div>
                        ...
                        <h6>
                            Hello @datkominformatics, je suis <span class="fw-bolder"><?php echo $message['nom']; ?></span>.<br><br>
                            Vous pouvez me contacter sur <span class="fw-bolder"><?php echo $message['email']; ?></span> ou sur <span class="fw-bolder"><?php echo $message['phone']; ?></span>
                            Voici mon message <br><br>
                            <span class="fw-bolder"><?php echo $message['message']; ?>
