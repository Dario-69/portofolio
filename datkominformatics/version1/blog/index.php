...
//   
    ...
    // $statement = $pdo->prepare("SELECT * FROM blog ORDER BY id DESC LIMIT 1;");
    // $statement->execute();
...
<head>
    ...
    <meta name="description" content="On a de la lecture pour vous : web, design etc. Il y en a pour tout le monde. Venez lire les conseils d&#039;une agence digitale internationale."/>
...
<body>
    ...
    <div class="content mb-5">
                            ...
                            <ul>
                                ...
                                <nav class="overlay-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="page-link-2" href="#">Blog</a></li>
        ...
        <div class="container mt-5 ">
                ...
                <div class="col-md-10 col-12">
                    ...
                    <div class="row text-center mt-5 mb-5">
                        ...
                        <div class="col-md-4 col text-center">
                            ...
                            <a class="toopiic" href="topic/branding/index.php">Branding</a>
    
                        </div>
    
                        <div class="col-md-4 col text-center">
    
                            <a class="toopiic" href="topic/design/index.php">Design</a>
    
                        </div>
    
                        <div class="col-md-4 col text-center">
    
                            <a class="toopiic" href="topic/web/index.php">Web</a>
            ...
            <div class="row droite_text mt-5">
