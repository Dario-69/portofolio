...
<head>
    ...
    <link rel="stylesheet" href="../../design/css/post.css">
    ...
    <div class="content">
                            ...
                            <ul>
                                ...
                                <nav class="overlay-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="page-link-2" href="our-agency/index.php"><?php echo $blog_infos['titre'] = 'Dernier article'; ?></a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="blog-top">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <h1><?php echo $blog_infos['titre']; ?></h1>
        ...
        <div class="container mt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <?php echo nl2br(html_entity_decode($blog_infos['note'])); ?>
        ...
        <!-- <div class="container-fluid">
            ...
            <div class="row text-center">
                ...
                <a href="" class="col-md-4">Web</a>
                <a href="" class="col-md-4">Design</a>
                <a href="" class="col-md-4">Branding</a>
