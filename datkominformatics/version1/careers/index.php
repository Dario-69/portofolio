            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-left">
                        ...
                        <h1 id="titre">Agence créative, nous sommes<br>toujours curieux de rencontrer<br>de nouveaux profils</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    if($sth->rowCount() > 0){?>
                        ...
                        <?php foreach ($careers as $career): ?>
                            ...
                            <div id="offre">
                                ...
                                <span><?= $career['what'];?></span>
                                <h4><?= $career['nom'];?></h4>
                                <hr>
                                <span>Date en ligne</span>
                                <h6><?= $career['dateligne'];?></h6>
                                <span>Date de debut</span>
                                <h6><?= $career['datedebut'];?></h6>
                                <hr>
                                <p><?= $career['message'];?></p>
                                <a href="mailto:hello@datkominformatics.com">Postuler</a>
                ...
                <?php
                        ...
                        <p>Nous n'avons pas d'offres en ce moment</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 id="ready">Prêt à<br>discuter de votre<br>prochain projet ?</h1>
